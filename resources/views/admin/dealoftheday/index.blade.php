                              ...
                              <tr>
                                <td>
                                  @if($value->productDetails && $value->productDetails->image)
                                    <img src="{{asset('/uploads/product').'/'.$value->productDetails->image}}"  alt="{{$value->productDescriptionAdmin?->name}}"  class="img-thumbnail img-fluid" style=" width: 60px;height: 60px;">
                                  @else
                                    <img src="{{asset('/assets/img/default.png')}}"  alt="{{$value->productDescriptionAdmin?->name}}"  class="img-thumbnail img-fluid" style=" width: 60px;height: 60px;">
                                  @endif
                                </td>

                                  <td class="budget">{{ $value->productDescriptionAdmin  != null ? $value->productDescriptionAdmin?->name : '' }}</td>
