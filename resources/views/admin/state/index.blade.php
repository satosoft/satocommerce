            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-black d-inline-block">State</h6>
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <a href="{{ route('state.add') }}" class="btn btn-lg btn-neutral fade-class"><i class="fas fa-plus fa-lg"></i> New</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <form action="{{ route('state') }}">
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <a href="{{ route('state') }}" class="btn btn-info"><i class="fas fa-sync-alt"></i></a>
                            </div>
                        </div>
                    </form>
                </div>
                                    ...
                                    <td class="">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <a class="dropdown-item" href="{{ route('state.edit',['id' => $value->state_id]) }}">Edit</a>
                                                <a class="dropdown-item deleteData" type="button"  href="javascript:void(0)" data-url="{{ route('state.delete',['id' => $value->state_id]) }}">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
