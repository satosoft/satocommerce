            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h6 class="h2 text-black d-inline-block">Tax Class</h6>
                    ...
                    <form action="{{ route('tax-class') }}">
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <a href="{{ route('tax-class') }}" class="btn btn-info"><i class="fas fa-sync-alt"></i></a>
                            </div>
                        </div>
                    </form>
                </div>
                                    ...
                                    <td class="">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                <a class="dropdown-item" href="{{ route('tax-class.edit',['id' => $value->tax_class_id]) }}">Edit</a>
                                                <a class="dropdown-item deleteData" type="button"  href="javascript:void(0)" data-url="{{ route('tax-class.delete',['id' => $value->tax_class_id]) }}">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
