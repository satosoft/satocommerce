                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('tax-rate.update',['id' => $data->id]) }}"  autocomplete="off">
                            ...
                            <div class="pl-lg-4 row">
                                ...
                                <div class="col-md-4 form-group{{ $errors->has('type') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="zone_id">{{ __('Geo Zone') }}</label>
                                    <select class="form-control" name="zone_id">
                                        @foreach($geozones as $key => $zone )
                                            <option value="{{ $zone->id }}" @if($zone->id == $data->zone_id) selected="true" @endif>{{ $zone->name }}</option>
                                        @endforeach
                                    </select>
