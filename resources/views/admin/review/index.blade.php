                    ...
                    <table class="table align-items-center table-flush">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th scope="col" class="sort" data-sort="status">Text</th>
                        ...
                        <tbody class="list">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <img src="{{asset('public/uploads/product').'/'.$value->product?->image}}"
                                    ...
                                    @endif
                                    <p>
                                        <a href="{{route('product.edit',['id' => $value->product?->id])}}"
                                            target="_blank">View Product</a>
                                    </p>

                                </td>
                                <td class="budget">{{ $value->customer->firstname }} {{ $value->customer->lastname }}
                                </td>
                                <td class="budget">{{ $value->rating }}</td>
                                <td class="budget">
                                    <p class="p-wrap">{{ $value->text }}</p>
                                </td>
                                <td class="">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            <a class="dropdown-item"
                                                href="{{ route('review.edit',['id' => $value->id]) }}">Edit</a>
                                            <a class="dropdown-item deleteData" type="button" href="javascript:void(0)"
                                                data-url="{{ route('review.delete',['id' => $value->id]) }}">Delete</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
