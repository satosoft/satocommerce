                            ...
                            <tbody>
                                <tr>
                                    <td class="esd-stripe" esd-custom-block-id="1735" align="center">
                                        <table class="es-header-body" style="background-color: #fff;" width="600"
                                                ...
                                                <tr>
                                                    <td class="esd-structure es-p5t es-p5b es-p15r es-p15l"
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-image es-m-p0l es-p15l es-m-txt-c"
                                                                                        ...
                                                                                        style="font-size:0"><a
                                                                                            href="{{url('/')}}"
                                                                                            target="_blank"><img
                                                                                                src="{{url(config('constant.file_path.store'))}}/{{config('settingConfig.config_store_image')}}"
                                                                                                alt="Otrixcommerce logo"
                                                                                                title="Otrixcommerce logo"
                                                                                                width="118"></a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                        ...
                                                        <table cellspacing="0" cellpadding="0" align="right">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="esd-container-frame" width="370"
                                                                        align="left">
                                                                        <table width="100%" cellspacing="0"
                                                                            cellpadding="0">
                                                                            <tbody>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="esd-container-frame" width="560"
                                                                        valign="top" align="center">
                                                                        <table
                                                                            style="border-radius: 0px; border-collapse: separate;margin-top:10px"
                                                                            width="100%" cellspacing="0"
                                                                            cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p5t es-p5b es-p40r es-p40l"
                                                                                        ...
                                                                                        <p style="color: #333333;">
                                                                                            ...
                                                                                            us
                                                                                            {{config('settingConfig.config_telephone')}}.
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                                <!-- <tr>
                                                                                        ...
                                                                                        <table style="width: 100%;"
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td><span
                                                                                                            style="font-size: 14px; line-height: 150%;">{{$orderData['invoice_no']}}</span>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td><span
                                                                                                    ...
                                                                                                    <td><span
                                                                                                            style="font-size: 14px; line-height: 150%;">{{date('M
                                                                                                            d
                                                                                                            Y',strtotime($orderData['order_date']))}}</span>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td><span
                                                                                                    ...
                                                                                                    <td><span
                                                                                                            style="font-size: 14px; line-height: 150%;">{{config('settingConfig.config_currency')}}{{number_format($orderData['grand_total'],2)}}</span>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                        ...
                                                                        <table
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p20b es-p20r es-p20l"
                                                                                        align="left">
                                                                                        <p>{{$orderData['firstname']}}
                                                                                        </p>
                                                                                        <p>{{$orderData['shipping_address_1']}}
                                                                                        </p>
                                                                                        <p>{{$orderData['shipping_city']}},{{$orderData['shipping_postcode']}}
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                    ...
                                    <td class="esd-stripe" esd-custom-block-id="1758" align="center">
                                        <table class="es-content-body" width="600" cellspacing="0" cellpadding="0"
                                            ...
                                            <tbody>
                                                ...
                                                @php $totalItems += $product['quantity']; @endphp
                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-image"
                                                                                        ...
                                                                                        style="font-size:0"><a
                                                                                            href="{{url('/')}}"
                                                                                            target="_blank"><img
                                                                                                src="{{url(config('constant.file_path.product'))}}/{{$product['image']}}"
                                                                                                alt="{{$product['name']}}"
                                                                                                class="adapt-img"
                                                                                        ...
                                                                                        <table style="width: 100%;"
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td style="text-align: center;"
                                                                                                        width="100">
                                                                                                        {{config('settingConfig.config_currency')}}{{$product['total']}}
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                                        ...
                                                                                        <table style="width: 500px;"
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr
                                                                                                    ...
                                                                                                    <td
                                                                                                        style="text-align: right; font-size: 16px; line-height: 150%;">
                                                                                                        Subtotal
                                                                                                        ({{$totalItems}}
                                                                                                        items):</td>
                                                                                                    <td
                                                                                                        style="text-align: right; font-size: 16px; line-height: 150%;">
                                                                                                        {{config('settingConfig.config_currency')}}{{number_format($orderData['total'],2)}}
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr
                                                                                                    style="margin-bottom:20px;">
                                                                                                    <td
                                                                                                        ...
                                                                                                        Shipping:</td>
                                                                                                    <td
                                                                                                        style="text-align: right; font-size: 16px; line-height: 150%; color: #d48344;">
                                                                                                        <strong>{{config('settingConfig.config_currency')}}{{$orderData['shipping_charge']}}</strong>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td
                                                                                                        style="text-align: right; font-size: 16px; line-height: 150%;">
                                                                                                        {{config('settingConfig.config_currency')}}{{
                                                                                                ...
                                                                                                <tr
                                                                                                    ...
                                                                                                    <td
                                                                                                        style="text-align: right; font-size: 16px; line-height: 150%;">
                                                                                                        {{config('settingConfig.config_currency')}}{{number_format($orderData['discount'],2)}}
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr
                                                                                                    style="margin-bottom:20px;">
                                                                                                    ...
                                                                                                    <td
                                                                                                        style="text-align: right; font-size: 16px; line-height: 150%; color: #626ABB;">
                                                                                                        <strong>{{config('settingConfig.config_currency')}}{{number_format($orderData['grand_total'],2)
                                                                                                            }}</strong>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-image es-m-p0l es-m-txt-c"
                                                                                        ...
                                                                                        style="font-size:0"><a href
                                                                                            target="_blank"><img
                                                                                                src="{{url(config('constant.file_path.store'))}}/{{config('settingConfig.config_icon_image')}}"
                                                                                                alt="Otrixcommerce logo"
                                                                                                title="Otrixcommerce logo"
                                                                                                width="108"></a></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p10t es-p5b es-m-txt-c"
                                                                                        align="left">
                                                                                        <p>{{config('settingConfig.config_store_name')}}
                                                                                            Inc</p>
                                                                                        <p>{{config('settingConfig.config_address')}}
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p5t es-m-txt-c"
                                                                                        align="left">
                                                                                        <p><a target="_blank"
                                                                                                href="tel:123456789">{{config('settingConfig.config_telephone')}}</a><br><a
                                                                                                target="_blank"
                                                                                                href="{{config('settingConfig.config_email')}}">{{config('settingConfig.config_email')}}</a>
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-m-txt-c"
                                                                                        align="left">
                                                                                        <p>Note: This email will serve
                                                                                            as an official receipt for
                                                                                            this payment.<br></p>
                                                                                    </td>
                                                                                </tr>
                                                                                <!-- <tr>
